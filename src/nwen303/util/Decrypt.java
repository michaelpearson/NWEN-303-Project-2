...
public class Decrypt {
    ...
    /**
     * Example of using util.Blowfish to decrypt a given ciphertext and key.
     * <p>
     * Errors are suppressed, if this fails the output will be null.
     *
     * @param args key represented as a big integer value, key size, ciphertext encoded as base64 value
     */
